...
# Code to be Ran
EnTAP --run --run-ini /scratch/drt83172/Wallace_lab/RNA_SEQ/EnTAP/Params/entap_run.params --entap-ini /scratch/drt83172/Wallace_lab/RNA_SEQ/EnTAP/Params/entap_config.ini
