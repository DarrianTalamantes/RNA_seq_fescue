#!/bin/bash
#SBATCH -J InterproPractice
#SBATCH -p batch
#SBATCH --ntasks=24
#SBATCH --mem 60gb
#SBATCH -t 8:00:00
#SBATCH --output=/scratch/drt83172/Wallace_lab/RNA_SEQ/Scripts/outfiles/InterproPractice.%j.out
#SBATCH -e /scratch/drt83172/Wallace_lab/RNA_SEQ/Scripts/outfiles/InterproPractice.%j.err
